...
extern void PORTIO_enter_DefaultMode_from_RESET(void) {
	...
	/* Pin PD4 is configured to Input enabled with pull-up and filter */
	GPIO->P[3].DOUT |= (1 << 4);
	GPIO->P[3].MODEL = (GPIO->P[3].MODEL & ~_GPIO_P_MODEL_MODE4_MASK)
			| GPIO_P_MODEL_MODE4_INPUTPULLFILTER;

	/* Pin PD5 is configured to Input enabled with pull-up and filter */
	GPIO->P[3].DOUT |= (1 << 5);
